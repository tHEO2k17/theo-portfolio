          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-accent-bronze/10 to-accent-warm/5 border border-accent-bronze/20 rounded-lg p-8">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Good teams need clarity and ownership. I set direction, remove
                blockers, and help engineers ship reliable software.
              </p>
              <p className="text-text-secondary leading-relaxed mb-4">
                Systems should scale. Teams should grow. That is the work.
              </p>
              <p className="text-text-secondary leading-relaxed">
                I focus on product development, systems thinking, and team
                leadership across web, mobile, and cloud.
              </p>
            </div>
